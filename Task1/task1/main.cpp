...
int main()
{
    ...
    cout<<"k= "<<k<<endl<<endl<<endl;//проверяем значение переменной k после вызова функции. У нас вывелось k=9, но в функции мы меняли значение k=10. Следовательно получили, что переменная k (из main) и k (из setPointer) это 2 разные переменные.
